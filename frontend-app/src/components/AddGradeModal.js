...
class AddGradeModal extends Component{
    ...
    doSubmit = async () => {
        ...
        await fetch("/api/add-grade", requestOptions)
                            ...
                            <div className={`grid grid-cols-5`}>
                                ...
                                <div className="col-span-1">
                                    ...
                                    <div class="relative inline-flex">
                                        ...
                                        <select id="grade" onChange={this.handleChange.bind(this)} class="text-center border border-gray-300 rounded-lg text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
