import { faAngleDoubleRight, faChevronCircleLeft, faDownload, faFile, faIdCard, faPlug, faPlus } from "@fortawesome/free-solid-svg-icons";
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            <div class="w-5/6 mx-auto">
                                <div class="bg-white shadow-sm rounded-lg border-2 my-6">
                                    ...
                                    <thead>
                                        <tr>
                                        <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">TODOS</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td class="py-4 px-6 border-b border-grey-light">
                                            ...
                                            <button className="bg-white border-gray-800 ml-1 px-2 py-2 border rounded-md  font-bold shadow-sm text-sm hover:shadow-md">Add Submission
